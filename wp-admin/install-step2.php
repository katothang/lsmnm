...
<head>
    ...
    <link rel='stylesheet' id='buttons-css' href='../wp-includes/css/buttons.min.css?ver=5.1.1'
        type='text/css' media='all' />
    <link rel='stylesheet' id='install-css' href='../wp-admin/css/install.min.css?ver=5.1.1'
        type='text/css' media='all' />
</head>

<body class="wp-core-ui">
    <p id="logo"><a href="https://wordpress.org/">WordPress</a></p>
    <h1 class="screen-reader-text">Thiết lập kết nối cơ sở dữ liệu</h1>
    <form method="post" action="install-config.php?step=2">
        ...
        <table class="form-table">
            <tr>
                <th scope="row"><label for="dbname">Tên Database</label></th>
    ...
    <script type='text/javascript' src='../wp-admin/js/language-chooser.min.js?ver=5.1.1'></script>
</body>
